...
[panels,"large",role="center",scale="0.5"]
----
panels {
theme {
        scale=0.5f
...
[release,scale=0.7,role="center", animate="OFF", numChars="25"]
----
include::example3.json[]
----
...
[timeline,title="Demo timeline Builder by docops.io",scale="1.0"]
----
-
date: July 23rd, 2023
...
[roadmap,scale="1.0", role="left", numChars="25"]
----
- now
...
----
{
  ...
  "buttonDisplay": {
    "columns": 5,
    "colors": [
    "#080000", "#100000", "#180000", "#200000", "#280000", "#300000", "#380000", "#400000"
    ],
    "buttonStyle": {
      "labelStyle": "font-family: Arial, Helvetica, sans-serif; font-size: 14px; fill: #fcfcfc; letter-spacing: normal;font-weight: bold;"
    },
    "scale": 0.7
  }
}
