...
panels {
    theme {
        ...
        legendOn = false
        dropShadow = 1
        gradientStyle = GradientStyle(gradientId= "grad_1679021189141", color1 = "#282525", color2 = "#252424", color3 = "#252424", fontColor = "#cd9d72", titleColor = "#e06666", panelStroke = PanelStroke(color = "#cd9d72", width = 5))
    }
    slim {
        link = "https://www.google.com"
        label = "Google"
...
[cols="1",frame="none"]
!===
a|image::http://localhost:8010/extension/api/panel?type=SVG&data=H4sIAAAAAAAA_ytIzEvNKVao5lIAggIQB8oGgZzMvGwFWwWljJKSgmIrff3y8nK99Pz89JxUveT8XCWEusQkoD6gwpCMzGIFz2IFx7z8kozUIgV3sGKIwlqirUgsKMBpgyNIjlQDczOTi_KL89NKcBjqC5Mn2aW5iVX5ebicCpYk1ci81JK0nMwKHGb6QWRhhtYCADFl-A2_AQAA&file=xyz.svg[format=svg,opts=inline]
!===
