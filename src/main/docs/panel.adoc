...
[badge]
----
Badges|Are|https://www.google.com|RED
Badges|Are|https://www.apple.com|RED|
Cool|Aren't They?|https://www.yahoo.com|BLUE|ORANGE
----
-----
...
[cols="1,1,3,4,3"]
|===
|Label |Message |Url |Label Color | Message Color
...
|Color for message, this is Optional and Defaults to GREEN
|===
